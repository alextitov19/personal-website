// @ts-nocheck — vendor-exported HTML from a legal-doc generator; uses non-standard <bdt> tags and msoThemecolor CSS.
import { LegalShell } from "@/components/LegalShell";
export default function AlgoNinjaTermsOfService() {
  return (
    ...
    <>
      <div className="container">
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            <bdt className="question">
              We are a mobile app that allows users to create a profile for
              their dog. This information is displayed to others when the users
              are "walking". The goal is for users to meet other dog owners to
              socialize their dogs and themselves.
            </bdt>
          </div>
          <div
            className="MsoNormal"
          ...
          >
            ...
            >
              ...
              <bdt className="block-component">
                email at <bdt className="question">alextitov203@gmail.com</bdt>
                <bdt className="block-component" /> or by mail to{" "}
                <bdt className="question">10542 Monterey Ridge Drive</bdt>
                <bdt className="block-component" />,{" "}
                <bdt className="question">San Diego</bdt>
                <bdt className="block-component" />
                <bdt className="block-component" />,{" "}
                ...
                <bdt className="block-component" />
                <bdt className="block-component" />{" "}
                <bdt className="question">92127</bdt>
                <bdt className="statement-end-if-in-editor" />
                <bdt className="block-component" />
                <bdt className="block-component">,&nbsp;</bdt>
          ...
          >
            ...
            >
              ...
              <bdt className="statement-end-if-in-editor" />
              ), and <bdt className="question">Aleksandr Titov</bdt>, concerning
          ...
          >
            ...
            >
              ...
              Terms <bdt className="block-component" />
              from time to time
              <bdt className="else-block" />. We will alert you about any
              changes by updating the <bdt className="block-component" />
              "Last updated"
        ...
        <div align="center" style={{ textAlign: "left" }}>
                      ...
                      <bdt data-type="conditional-block">
                        <bdt data-type="body">
                          ...
                          >
                            ...
                            jurisdiction in which they reside (generally under
                            the age of 18) must have the permission of, and be
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            <a data-custom-class="link" href="#license">
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class="body_text">
                  8. CONTRIBUTION <bdt className="block-component" />
                  LICENSE
                  <bdt className="statement-end-if-in-editor" />
                </span>
              </span>
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            <a data-custom-class="link" href="#mobile">
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class="body_text">
                  <bdt className="block-component" />
                  9. MOBILE APPLICATION <bdt className="block-component" />
                  LICENSE
                  <bdt className="statement-end-if-in-editor" />
                  <bdt className="statement-end-if-in-editor" />
                </span>
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            <a data-custom-class="link" href="#law">
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class="body_text">15. GOVERNING LAW</span>
              </span>
            </a>{" "}
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            <a data-custom-class="link" href="#corrections">
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class="body_text">17. CORRECTIONS</span>
              </span>
            </a>{" "}
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            <a data-custom-class="link" href="#disclaimer">
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class="body_text">18. DISCLAIMER</span>
              </span>
            </a>{" "}
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            <a data-custom-class="link" href="#indemnification">
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class="body_text">20. INDEMNIFICATION</span>
              </span>
            </a>{" "}
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            <a data-custom-class="link" href="#userdata">
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class="body_text">21. USER DATA</span>
              </span>
            </a>{" "}
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            <a data-custom-class="link" href="#misc">
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class="body_text">24. MISCELLANEOUS</span>
              </span>
            </a>{" "}
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            <a data-custom-class="link" href="#contact">
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class="body_text">25. CONTACT US</span>
              </span>
            </a>
          </div>
        </div>
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            <span style={{ fontSize: 15 }}>
              <bdt className="block-component" />"
              <bdt className="statement-end-if-in-editor" /> section below, we
          ...
          >
            ...
            >
              ...
              <bdt className="question">alextitov203@gmail.com</bdt>. If we ever
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            <span style={{ fontSize: 15 }}>
              ...
              <bdt className="block-component" />"
              <bdt className="statement-end-if-in-editor" /> section carefully
              prior to using our Services to understand the (a) rights you give
              us and (b) obligations you have when you post or upload any
          ...
          >
            <span style={{ fontSize: 15 }}>
              ...
              Contributions, and to <bdt className="block-component" />
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              in <bdt className="question">__________</bdt>.
            </span>
          </div>
        </div>
        <div align="center" style={{ lineHeight: "1.5" }}>
          ...
          >
            ...
            >
              ...
              >
                ...
                <bdt className="block-component" />
                endeavors
                <bdt className="statement-end-if-in-editor" /> except those that
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              unauthorized
                              <bdt className="statement-end-if-in-editor" /> use
                ...
                <bdt data-type="body">
                  ...
                  >
                    ...
                    >
                      This <bdt className="block-component" />
                      license
                      <bdt className="statement-end-if-in-editor" /> will apply
                ...
                <bdt data-type="body">
                  ...
                  >
                    ...
                    >
                      ...
                      Contributions to place them in more appropriate locations
                      on the Services; and (3) to pre-screen or delete any
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              mobile application <bdt className="block-component" />
              license
              <bdt className="statement-end-if-in-editor" /> contained in these
              Legal Terms. You shall not: (1) except as permitted by applicable
              law, decompile, reverse engineer, disassemble, attempt to derive
              the source code of, or decrypt the App; (2) make any modification,
              ...
              <bdt className="block-component" />
              endeavor
              <bdt className="statement-end-if-in-editor" />, commercial
          ...
          >
            ...
            >
              ...
              <bdt className="block-component" />
              "App Distributor"
              <bdt className="statement-end-if-in-editor" />) to access the
              Services: (1) the <bdt className="block-component" />
              license
              <bdt className="statement-end-if-in-editor" /> granted to you for
              our App is limited to a non-transferable{" "}
              <bdt className="block-component" />
              license
              <bdt className="statement-end-if-in-editor" /> to use the
              application on a device that <bdt className="block-component" />
              utilizes
              <bdt className="statement-end-if-in-editor" /> the Apple iOS or
              ...
              the App; (3) in the event of any failure of the App to conform to
              ...
              <bdt className="statement-end-if-in-editor" /> country and (ii)
              ...
              <bdt className="block-component" />,
              <bdt className="statement-end-if-in-editor" /> if you have a VoIP
          ...
          >
            ...
            <strong>
              ...
              <span style={{ color: "rgb(0, 58, 250)" }}>
                ...
                >
                  <a
                    href="http://www.alextitov.com/project/parkpals/privacy"
                    target="_blank"
                    data-custom-class="link"
                  >
                    http://www.alextitov.com/project/parkpals/privacy
                  </a>
                </bdt>
              </span>
            </strong>
            ...
            <bdt className="block-component" />, and you expressly consent to
        ...
        >
          <span style={{ fontSize: 15 }}>
            ...
            the jurisdiction of the <bdt className="block-component" />
            <bdt className="question">__________</bdt>
            <bdt className="statement-end-if-in-editor" /> courts.{" "}
            <bdt className="question">Aleksandr Titov</bdt> shall also maintain
        ...
        >
          ...
          >
            ...
            <bdt className="block-component" />
            UNAUTHORIZED
            <bdt className="statement-end-if-in-editor" /> ACCESS TO OR USE OF
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: "14.6667px" }}>5</span>) your violation of
            ...
            <bdt className="block-component" />
            defense
            <bdt className="statement-end-if-in-editor" /> of such claims. We
        ...
        >
          <strong>
            ...
            >
              <strong>
                <bdt className="question">alextitov203@gmail.com</bdt>
              </strong>
            </span>
          </strong>
        </div>
